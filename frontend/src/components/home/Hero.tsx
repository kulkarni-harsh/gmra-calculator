...
import ReportPreviewFan from '@/components/home/ReportPreviewFan'
...
const STATS: ReadonlyArray<{ num: React.ReactNode; label: string; sub?: string }> = [
  ...
  { num: <span className="text-mcrec-blue">Any</span>, label: 'Specialty', },
...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="relative grid gap-12 lg:grid-cols-[minmax(0,1.02fr)_minmax(360px,0.98fr)] lg:items-center">
        <div>
          ...
          <p className="mt-5 max-w-[640px] text-[15px] leading-[1.8] text-white/70">
            ...
            is a patent-pending market intelligence tool that uses CPT, DRG, and ICD-10 billing
            code data to analyze the income-producing factors of any medical office location in the
            United States. Before you sign a lease, renew one, or open a new facility — you need to
            know what the market actually supports for your specialty. The Calculator gives
            independently growing practices access to the same clinical demand intelligence hospital
            systems have used for years.
          </p>
          ...
          <p className="mt-3 max-w-[580px] text-[11px] leading-[1.7] text-white/40">
            ...
            systems or large health networks. Built from market-level CPT, DRG, and ICD-10 data.
            Zero patient records. Zero PHI. Ever.
          </p>
